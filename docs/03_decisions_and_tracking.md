...
| M2 Foundation | In progress | SQLite schema v5, app identity, dashboard pairing preparation, password verifiers and SQLCipher database opening implemented; phone migration and user data visibility checks passed |
...
| M6 Sync preparation | Pairing preparation implemented; architecture and API contract drafted | See 12_sync_architecture_decision.md and 13_dashboard_api_contract.md; next APK step is real dashboard pairing request/client code when the dashboard exists |
