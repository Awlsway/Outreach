...
| M2 Foundation | In progress | SQLite schema v4, app identity, dashboard connection state, password verifiers and SQLCipher database opening implemented; phone migration verification remains pending |
