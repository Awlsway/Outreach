...
| M2 Foundation | In progress | SQLite schema v4, app identity, dashboard connection state and password verifiers implemented; database encryption plan drafted in 16_database_encryption_plan.md; encryption implementation remains pending |
