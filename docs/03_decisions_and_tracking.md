...
| M6 Sync preparation | Pairing and retention preparation implemented; joint APK/LAN contract drafted | See 12_sync_architecture_decision.md, 13_dashboard_api_contract.md and 19_joint_sync_contract_status.md; next APK step is real dashboard pairing request/client code when the dashboard exists |
